...
uint256 hashGenesisBlock("0x4166eb8a53cac19a5f615e202f3137941b0d2ae4241f3af1f6ea1707b5817093");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // GirlyGiggle: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "GirlyGiggle Signed Message:\n";
...
{
    // GirlyGiggle: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // GirlyGiggle: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // GirlyGiggle: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // GirlyGiggle: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4166eb8a53cac19a5f615e202f3137941b0d2ae4241f3af1f6ea1707b5817093");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1418840183;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086813305;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GirlyGiggleMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GirlyGiggleMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running GirlyGiggle with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GirlyGiggleMiner terminated\n");
        throw;
    }
}
